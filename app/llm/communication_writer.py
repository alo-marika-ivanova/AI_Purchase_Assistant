...
# Controls whether negotiation messages try Ollama first.
# If Ollama fails, fallback templates are used automatically.
...
"""
    ...
    try:
        ...
        return {
            "success": True,
            "method": "ollama_communication_writer",
            "message": message,
        ...
        fallback["method"] = "fallback_after_ollama_failed"
