...
from app.services.transport_worker_service import run_email_worker_cycle
...
def main() -> None:
    ...
    print("Purchasing workflow worker started.")
    ...
    while True:
        try:
            results = run_email_worker_cycle()
            print_cycle_result(results)

        except KeyboardInterrupt:
            print("Purchasing workflow worker stopped.")
            break
